...
def _python_collectors() -> list[Callable[[], SourceResult]]:
    return [
        ...
        lambda: collect_soup_links(
            "Devico",
            "https://devico.io/careers",
            base_url="https://devico.io/",
            selector="a[href*='/careers/']",
            title_selector='p[class*="VacanciesSlider_name"]',
            location_selector='p[class*="VacanciesSlider_hot-vacancy"]',
            skip_exact={"https://devico.io/careers/", "https://devico.io/careers"},
        ),
        collect_intellias,
        collect_mwdn,
        collect_onix,
